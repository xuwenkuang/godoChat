...
# - 2D Incremental Clicker (default): "scenes/scene/game_content/game_content.tscn"
...
## 
## 功能说明：
## - 替换"GameContent"子场景为你自己的游戏内容（保持唯一名称）
## - 管理游戏暂停/继续状态
## - 提供游戏内选项菜单
## - 支持返回主菜单
## 
## 架构设计：
## - GameContent子节点：实际的游戏玩法内容
## - PauseMenu：暂停菜单界面
## - OptionsMenu：游戏内选项界面
## - UiBuilder：动态构建UI元素
## 
## 可扩展函数：
## - _after_pause(): 暂停后的回调（如释放鼠标）
## - _after_unpause(): 继续后的回调（如捕获鼠标）
## - _after_leave(): 离开游戏场景的回调
## 
## 输入处理：
## - ESC键切换暂停菜单或从选项菜单返回
## 
